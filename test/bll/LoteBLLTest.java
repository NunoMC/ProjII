...
public class LoteBLLTest {
    ...
    public void setUp() {
        ...
        lt = new Lote();
        lt.setPreco(new BigDecimal(1.1));
        lt.setQtdcompra(new BigDecimal(1));
        lt.setQtdlixo(new BigDecimal(2));
        lt.setQuantidade(new BigDecimal(10));
    ...
    public void testRefreshEntity() {
        ...
        lt.setPreco(new BigDecimal(12.12));
